export const WEBSITE_UPDATES = [
  {
    ...
    changes: [
      ...
      { text: 'Updated departmental responsibilities and committee membership. Removed internal order references from the public page.', href: '/about/administration/', label: 'Administration' },
      { text: 'Grouped Theory, Systems, and AI & Machine Learning under Research areas in the menu. Added clearer section pages and shorter descriptions.', href: '/research/', label: 'Research navigation' },
      { text: 'Added separate colour and typography choices. Links can include q=navy, forest, or terracotta and type=modern, system, or editorial.', href: '/?q=terracotta&type=editorial', label: 'Try a theme' },
      { text: 'Reduced page-loading overhead, served smaller portrait images locally, and removed the loading screen between pages.', href: '/', label: 'Homepage' },
    ],
  },
];
